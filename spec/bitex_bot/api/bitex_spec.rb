...
describe BitexBot::Api::Bitex do
  ...
  context '#place_order' do
    it 'raises OrderNotFound error on Bitex errors' do
      ...
      expect { api_wrapper.place_order(:buy, 10, 100) }.to raise_exception(BitexBot::Api::OrderNotFound)
      expect { api_wrapper.place_order(:sell, 10, 100) }.to raise_exception(BitexBot::Api::OrderNotFound)
    end
  end
  ...
  it '#user_transaction' do
    ...
    api_wrapper.user_transactions.all? { |o| o.should be_a(BitexBot::Api::UserTransaction) }
